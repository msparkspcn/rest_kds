...
contextBridge.exposeInMainWorld('ipc', {
  ...
  order: {
    ...
    getUnCompletedList: (sale_dt: string, cmp_cd: string, sales_org_cd: string, stor_cd: string, corner_cd: string) =>
      ipcRenderer.invoke('db:getUnCompletedOrderList', sale_dt, cmp_cd, sales_org_cd, stor_cd, corner_cd),
    getOrder: (sale_dt: string, cmp_cd: string, sales_org_cd: string, stor_cd: string, corner_cd: string, order_no_c: string) =>
      ipcRenderer.invoke('db:getOrder', sale_dt, cmp_cd, sales_org_cd, stor_cd, corner_cd, order_no_c),
